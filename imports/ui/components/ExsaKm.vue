<template>
  <section>
    <template>
      ...
      <v-slider v-model="kmValue" thumb-label="always" max="120" label="Limite de Velocidad" step="5"></v-slider>
    </template>
    <template>
      <section>
        <v-menu
...
import { stXSKM } from "../../api/streamers";
